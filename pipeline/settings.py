...
SECRET_KEY = 'django-insecure-2q!=#h9=iph*m*@9i4)5x%&mmgy)a%45u8yhjl---f8km+21dx'
...
PIPELINE_EXECUTION_BACKEND = 'local'  # Options: 'local', 'kubernetes', 'aws', 'gcp'

PIPELINE_BACKEND_CONFIG = {
    'local': {
        # Local execution backend has no additional config
    },
    'kubernetes': {
